...
內建規則會先檢查文字；非聯絡人的**第一則訊息**不需要包含網址，只要內容達到高信心垃圾訊息門檻，就會在即時防護中直接封鎖。判斷會合併垃圾類別、導流意圖、陌生新發送者、Telegram 可疑帳號標記與刻意變形等訊號，避免「出」「彩」「賣」這類單一常用字造成誤判。使用者明確加入的學習規則則視為明確封鎖規則，命中後會直接封鎖。
...
- 兩字中文同音詞若沒有更長的詞組或其他訊號，會降低權重，以避免把一般對話誤判為垃圾訊息。
